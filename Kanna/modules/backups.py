...
import Kanna.modules.sql.notes_sql as sql
from Kanna import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from Kanna.__main__ import DATA_IMPORT
from Kanna.modules.helper_funcs.chat_status import user_admin
from Kanna.modules.helper_funcs.alternate import typing_action

# from Kanna.modules.rules import get_rules
import Kanna.modules.sql.rules_sql as rulessql

# from Kanna.modules.sql import warns_sql as warnssql
import Kanna.modules.sql.blacklist_sql as blacklistsql
from Kanna.modules.sql import disable_sql as disabledsql

# from Kanna.modules.sql import cust_filters_sql as filtersql
# import Kanna.modules.sql.welcome_sql as welcsql
import Kanna.modules.sql.locks_sql as locksql
from Kanna.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Kanna{}.backup".format(chat_id), "rb"),
        caption="*Copia de seguridad exportada con éxito:*\nChat: `{}`\nChat ID: `{}`\nEn: `{}`\n\nNota: Este `Kanna-Backup`fue hecho especialmente para mensajes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
